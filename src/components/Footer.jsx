    ...
    <footer className="bg-gray-800 text-gray-300 py-12 border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">About This Blog</h3>
            <p className="text-gray-400">
              Cutting-edge tech news and tutorials curated by Nikesh Sapkota.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-400 mt-4">
              © {new Date().getFullYear()} Developed by <span className="text-white">Nikesh Sapkota</span>
            </p>
          </div>
        </div>
      </div>
